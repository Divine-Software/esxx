...
MACRO(ADD_RPM RPM_NAME)
  ...
  IF ("${ARGV1}" STREQUAL "")
	...
	COMMAND ${CMAKE_COMMAND} -E echo "find ${RPM_ROOTDIR}/tmp -type f -printf '/%%P\\n' > ${SPEC_FILE}.files" >> ${SPEC_FILE}
        COMMAND ${CMAKE_COMMAND} -E echo "" >> ${SPEC_FILE}

#        COMMAND ${CMAKE_COMMAND} -E echo "%files" >> ${SPEC_FILE}
        COMMAND ${CMAKE_COMMAND} -E echo "%files -f ${SPEC_FILE}.files" >> ${SPEC_FILE}
...
#        COMMAND ${CMAKE_COMMAND} -E echo "\"/*\"" >> ${SPEC_FILE}
  ...
  ADD_CUSTOM_COMMAND( TARGET ${RPM_NAME}_rpm PRE_BUILD
    COMMAND rm -rf ${SPEC_FILE} ${RPM_ROOTDIR}/tmp) 
